...
저희는 **르몽**이라는 회사와 협업하며, 문서 분석 및 AI 기반 문서 활용 시스템을 개발하고 있습니다.

저희 팀의 궁극적인 목표는 **HWP와 HWPX 문서를 AI가 이해할 수 있는 구조화된 데이터로 변환하고, 문서 내 텍스트·표·이미지 정보를 추출해 검색과 질의응답에 활용할 수 있도록 지원하는 문서 분석 시스템을 구축하는 것**입니다.

<br />

## 서비스 개발 배경

대한민국은 AI 3대 강국 도약을 목표로 공공·민간 영역의 AX 전환을 추진하고 있습니다.  
이를 위해서는 다양한 기관과 기업에서 생산되는 문서를 AI가 정확하게 읽고, 안전하게 검색 및 질의응답 시스템과 연결할 수 있는 문서 처리 인프라가 필요합니다.

특히 국내 행정·공공·기업 문서에는 HWP, HWPX와 같은 문서 형식이 많이 사용됩니다.
하지만 이러한 문서는 일반적인 AI 시스템이나 검색 시스템에서 바로 활용하기 어렵기 때문에, 문서 구조를 인식하고 AI가 이해 가능한 데이터로 변환하는 파서가 필요합니다.

<p align="center">
  <img width="777" alt="서비스 개발 배경" src="https://github.com/user-attachments/assets/622f58f2-1866-4083-9eb8-3e12f65a1ed2" />
</p>

<p align="center">
  <img width="80%" alt="AI 개발 배경" src="https://github.com/user-attachments/assets/78b47fb9-58f4-4ada-bffe-bd067067d5e9" />
</p>

<p align="center">
  <img width="884" alt="RAG 인프라 필요성" src="https://github.com/user-attachments/assets/f5efe3c5-1596-4f7f-9057-5dff7f204814" />
</p>

<p align="center">
  <img width="767" alt="문서 파서 필요성" src="https://github.com/user-attachments/assets/c23e153b-1564-47d6-b7a9-1ffde415f5b4" />
</p>
...
파서는 문서의 내용을 단순히 텍스트로 읽는 것을 넘어, 문서 안에 포함된 **문단, 표, 이미지, 배치, 계층 구조**를 분석하여 컴퓨터가 처리할 수 있는 구조화된 데이터로 변환하는 도구입니다.

Luminir Document Parser는 HWP, HWPX, PDF, 이미지 문서를 대상으로 문서 구조를 추출하고, 표와 이미지 같은 비정형 요소까지 AI가 활용 가능한 형태로 변환하는 것을 목표로 합니다.

<p align="center">
  <img width="893" alt="문서 구조 추출 및 분석" src="https://github.com/user-attachments/assets/57da5d0a-9b77-4216-b000-141b7df93ca7" />
</p>

<p align="center">
  <img width="862" alt="표 이미지 구조 인식" src="https://github.com/user-attachments/assets/164b3a71-c405-4a11-a811-fac658c508a6" />
</p>
...
Luminir Document Parser는 문서 업로드부터 변환 진행 상태 확인, 결과 미리보기, 문서 기반 질의응답까지 하나의 흐름으로 사용할 수 있도록 구성되어 있습니다.

<p align="center">
  <img width="100%" alt="서비스 실사용 화면" src="https://github.com/user-attachments/assets/c6e0ba30-a9a6-44f7-8a55-241ff24bbfe3" />
</p>
...
<p align="center">
  <img width="80%" alt="문서 업로드 화면" src="./docs/images/upload-preview.png" />
</p>

### 변환 결과 미리보기

<p align="center">
  <img width="80%" alt="변환 결과 미리보기" src="./docs/images/result-preview.png" />
</p>

### RAG 질의응답

<p align="center">
  <img width="80%" alt="RAG 질의응답 화면" src="./docs/images/rag-preview.png" />
</p>
...
<p align="center">
  <img width="100%" alt="시스템 아키텍처" src="https://github.com/user-attachments/assets/3a9a7bc5-8463-4e6f-a71a-5b5206f35a2f" />
</p>
...
- [API 문서](./backend/docs/API_DRAFT.md)
