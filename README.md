...
**LLMong**은 복잡한 업무 문서를 단순 파일이 아닌 **검색 가능한 지식 데이터**로 바꾸는 것을 목표로 합니다.
...
표 이미지는 셀 구조를 복원해 **HTML `<table>`과 Markdown table**로 변환하고, 차트는 축, 범례, 수치, 추세를 텍스트로 요약합니다.
...
<p align="center">
  <img width="88%" alt="문서 변환 화면" src="./assets/images/convertdoc.svg" />
</p>

### 변환 결과 보기

<p align="center">
  <img width="88%" alt="변환 결과 보기 화면" src="./assets/images/dashboarddoc.svg" />
</p>

### RAG 질의응답

<p align="center">
  <img width="88%" alt="RAG 질의응답 화면" src="./assets/images/rag.svg" />
</p>
