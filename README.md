...
특히 국내 행정·공공·기업 문서에는 HWP, HWPX와 같은 한국형 문서 형식이 많이 사용됩니다.  
...
<p align="center">
  <img width="767" alt="한국형 문서 파서 필요성" src="https://github.com/user-attachments/assets/c23e153b-1564-47d6-b7a9-1ffde415f5b4" />
</p>
...
Luminar Document Parser는 HWP, HWPX, PDF, 이미지 문서를 대상으로 문서 구조를 추출하고, 표와 이미지 같은 비정형 요소까지 AI가 활용 가능한 형태로 변환하는 것을 목표로 합니다.
...
- 한국형 문서의 AI 활용 기반을 마련하여 AX 전환에 기여
...
Luminar Document Parser는 문서 업로드부터 변환 진행 상태 확인, 결과 미리보기, 문서 기반 질의응답까지 하나의 흐름으로 사용할 수 있도록 구성되어 있습니다.
